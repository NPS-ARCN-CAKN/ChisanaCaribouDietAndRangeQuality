...
```{r, label="Figure: Basal percent cover across all plots", all plots",echo=FALSE,fig.cap=paste("Figure ",FigureCounter,". Basal percent cover across all sampling plots in the Chisana caribou herd range.",sep="")}
