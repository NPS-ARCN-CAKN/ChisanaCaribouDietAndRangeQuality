...
```{r, echo=FALSE,fig.cap=paste("Figure ",FigureCounter,". Mean lichen thickness (cm) and estimated biomass (kg/Ha) by ecotype. Error bars represent one standard deviation. Note that only one plot was sampled in the Forest ecotype.",sep="")}
...
```{r, echo=FALSE,tab.cap=paste("Table ",TableCounter,". Mean estimated lichen biomass (kg/Ha) by ecotype.  Note that only one plot was sampled in the Forest ecotype..",sep="")}
