...
```{r, label="Foliar cover figure",echo=FALSE,fig.cap=paste("Figure ",FigureCounter,". Foliar percent cover across all sampling plots in the Chisana caribou herd range.",sep="")}
...
```{r, label="Basal cover figure",echo=FALSE,fig.cap=paste("Figure ",FigureCounter,". Basal percent cover across all sampling plots in the Chisana caribou herd range.",sep="")}
...
# # Perform the ANOVA 
# Dataset_VegData$Ecotype = gsub("-","/",Ecotypes$Ecotype)
# anova_result <- aov(LichenHeight ~ Ecotype, data = Dataset_VegData)
# anova_result
# Tukey = TukeyHSD(anova_result) 
# 
# tukey_df = as.data.frame(Tukey$Ecotype)
# tukey_df$comparison = rownames(tukey_df)
# rownames(tukey_df) <- NULL
# 
# ColumnNames = colnames(tukey_df)
```
